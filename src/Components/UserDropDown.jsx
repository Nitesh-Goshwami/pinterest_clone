...
const UserDropDown = () => {
    ...
    <div className = {styles.user_dropdown}>
        ...
        <div className = {styles.userDetails}>
            <div>
                <img className = {styles.profile} src = "https://cdn-user-icons.flaticon.com/57417/57417507/1636545930691.svg?token=exp=1636546831~hmac=86d5319287a0e25debd9b852d38528a4" alt =""/>
            </div>
            <div>
                <h4>Name</h4>
        ...
        <h4 className = {styles.othercontent}>Logout</h4>
    </div>
    </>)
}
